...
=> Objetivo
Identificar las fortalezas del estudiante relacionadas a las temáticas trabajadas hasta la unidad 9 de este curso
...
5. La información capturada en los formularios se debe almacenar en una base de datos por medio de POST.

6. Debe haber una página que muestre el listado de pacientes con su información personal, por medio de GET.

7. Debe haber una página que muestra el listado de doctores  con su información, por medio de GET.

8. Debe haber una página que muestra el listado de citas con su información, por medio de GET.

9. Se debe utilizar Node JS, Express y TypeScript.

10. Utilice como motor de base de datos, MySQL o MongoDB.

11. Realice un documento con las pruebas unitarias.
